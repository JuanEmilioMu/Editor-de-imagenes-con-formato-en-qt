...
//figuras
void AreaPintar::figuras(){
    dibujarLineaRecta(QPoint(10, 10), QPoint(100, 100)); // Ejemplo de puntos de inicio y fin
}
...
void AreaPintar::dibujarLineaRecta(const QPoint &startPoint, const QPoint &endPoint) {
    QPainter painter(&image);
    painter.setPen(QPen(myColorLapiz, myAnchoLapiz, Qt::SolidLine, Qt::SquareCap));
